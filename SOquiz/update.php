...
<body>
	<div style="width: 500px; margin: 20px auto;">
		...
		<table width="100%" cellpadding="5" cellspacing="1" border="1">
			...
			<tr>
				<td>Imagem:</td>
				<td><input name="image" type="file"  value="<?php echo $data['image'];?>" required  ></td>
			</tr>
			<tr>
				<td>numberC:</td>
			...
			<tr>
				...
				<td> <?php echo ($data['corret_index']); ?>
					<select name="corret_index">
					  <option value="0"  <?php echo ($data['corret_index']=="0") ? "checked" : null;  ?> A</option>	
					  <option value="1"  <?php echo ($data['corret_index']=="1") ? "checked" : null;  ?> B</option>
					  <option value="2"  <?php echo ($data['corret_index']=="2") ? "checked" : null;  ?> C</option>
					  <option value="3"  <?php echo ($data['corret_index']=="3") ? "checked" : null;  ?> D</option>
					  <option value="4"  <?php echo ($data['corret_index']=="4") ? "checked" : null;  ?> E</option>
